...
var getForm = function getForm() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      var URL = 'http://localhost:3000/db.json';
      var formData = new FormData(item);
      var json = JSON.stringify(formData);
      Object(_services__WEBPACK_IMPORTED_MODULE_1__["getData"])(URL, json).then(function (response) {
...
/* harmony import */ var _photos__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./photos */ "./src/js/photos.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_timer__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_photos__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
var modal = function modal() {
  ...
  var getModal = function getModal(modalSelector, btn, closeSelector) {
  ...
  var getModalCalc = function getModalCalc() {
...
var photos = function photos() {
  var worksBtn = document.querySelectorAll('.works a');
  var div = document.createElement('div');
  var img = document.createElement('img');
  worksBtn.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      div.style.cssText = "\n\t\t\t\tposition: fixed;\n\t\t\t\ttop: 0;\n\t\t\t\tleft: 0;\n\t\t\t\twidth: 100%;\n\t\t\t\theight: 100%;\n\t\t\t\tz-index: 9;\n\t\t\t\tbackground-color: rgba(0, 0, 0, 0.8);\n\t\t\t";
      img.src = "".concat(item.href);
...
var getData = function getData(url, formData) {
  var res;
...
var tabs = function tabs() {
  ...
  var hideContent = function hideContent(tabContentSelector, tabBtnSelector, activeClass) {
    tabContentSelector.forEach(function (item) {
      item.style.display = 'none';
    });
    tabBtnSelector.forEach(function (item) {
  ...
  var showContent = function showContent(n, tabContentSelector, tabBtnSelector, activeClass) {
  ...
  glazingBlock.forEach(function (item) {
    item.addEventListener('click', function () {
      glazingContent.forEach(function (elem, i) {
  ...
  balconIconsImg.forEach(function (item) {
    item.addEventListener('click', function () {
      tabsImg.forEach(function (elem, i) {
  ...
  var decorationItem = document.querySelectorAll('.decoration_item .no_click'),
  ...
  decorationItem.forEach(function (item) {
    item.addEventListener('click', function () {
      decorationСontent.forEach(function (elem, i) {
...
var timer = function timer() {
  ...
  var _description = _slicedToArray(description, 4),
      dayVal = _description[0],
      hourVal = _description[1],
      minuteVal = _description[2],
      secondVal = _description[3];
  ...
  var numToStr = function numToStr(num, arrText) {
  ...
  var setClock = function setClock() {
    var t = getTimeRemaining(deadTime);
